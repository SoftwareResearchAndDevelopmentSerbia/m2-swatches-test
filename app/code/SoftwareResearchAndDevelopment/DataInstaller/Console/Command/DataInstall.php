...
namespace SoftwareResearchAndDevelopment\DataInstaller\Console\Command;
...
//                'Description of todoitem to be saved',
//                null
//            )
//            ->addArgument(
//                self::IS_COMPLETED,
//                InputArgument::OPTIONAL,
//                'Is todo item completed ?',
//                false
//            );
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $output->writeln('');
            $output->writeln('<info>'.print_r($simple_products).'</info>');
            $output->writeln('');
